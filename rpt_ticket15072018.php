...
function Header()
{
	...
	$this->Text(2,5,'Agencia Lia',0,'C', 0);
...
function Footer()
{
	...
	$pdf->SetXY(1, 14);
	$pdf->Cell(2,4,'Fecha:' .date("d-m-Y H:m:s"),0,1);
    ...
    $pdf->SetXY(1, 18);
	$pdf->Cell(1,6,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1); 
   ...
   //$id_instancia_saldo = $nro_patente;
	...
	$pdf->SetFont('Arial','',7);
	$pdf->SetXY(1, $linea+2);
	$pdf->Cell(1,3,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1);
	$pdf->SetFont('Arial','',7);
	$pdf->SetXY(1, $linea+4);
