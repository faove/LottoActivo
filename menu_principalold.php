...
<table class="table">
				  ...
				  <div align="left">
					<input name="buscar_txt" type="text" class="form-control" id="input_2"
						...
						onkeyup="if(navegaTeclado(event)==1) {
							...
							style="font-size: 20; "							
							onKeyPress="return soloNumeros(event,'monto') "
							autocomplete="off"
	...
	<label for="monto-sm">Monto:</label>
    	<input class="form-control monto-sm" id="monto" name="monto" type="text" onKeyPress="return soloNumeros(event,'insert')"  onKeyDown="return limitar(event,this.value,4)">
...
?>
	...
	<button type="submit" class="msg-basico-txt btn btn-info" value="Agregar" id="insert" name="insert" onKeyPress="return soloNumeros(event,'buscar_txt')">Agregar</button>
